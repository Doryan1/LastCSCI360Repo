...
public class admin implements ActionListener{
	...
	public void ad()  {
    	...
    	btnReturnProf = new JButton("return");
    	btnReturnProf.setBounds(806, 439, 63, 23);
    	adminprofpanel.add(btnReturnProf);
    	btnReturnProf.addActionListener(new quit()) ;
    	...
    	btnAddProf.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent e) {		
    			try {
					...
					//pst is called at the top as a static 
    	...
    	//this is the modify button for the Professor Manager
    	JButton btnModifyProf = new JButton("Modify");
    	btnModifyProf.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent e) {
    			try {
    	            ...
    	            String query = "update Professor set id='"+value1+"',department='"+value2+"',fname = '"+value3+"',lname='"+value4+"',dob= '"+value5+"',cteaching='"+value6+"',ctaught='"+value7+"', TA='"+value8+"' where id='"+value1+"' " ;
    	            pst = db.prepareStatement(query) ; 
    	            pst.execute(); 
    	...
    	//this is the delete button for the Professor Manager
    	JButton btnDeleteProf = new JButton("Delete");
    	...
    	//this is the update button for the Professor Manager
    	JButton btnUpdateProf = new JButton("Update Table");
    	...
    	btnModifyTA.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent e) {
    			try {
    	            ...
    	            String query = "update TA set id='"+value1+"',department='"+value2+"',fname = '"+value3+"',lname='"+value4+"',dob= '"+value5+"',cassisting='"+value6+"',cassisted='"+value7+"' where id='"+value1+"' " ;
    	            pst = db.prepareStatement(query) ; 
    	            pst.execute(); 
    	            JOptionPane.showMessageDialog(null, "input modified") ;  
    	            pst.close(); 
    	...
    	btnModifyStaff.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent e) {
    			try {
    	            ...
    	            String query = "update staff set id='"+value1+"',department='"+value2+"',fname = '"+value3+"',lname='"+value4+"',dob= '"+value5+"' where id='"+value1+"' " ;
    	            pst = db.prepareStatement(query) ; 
    	            pst.execute(); 
    	            JOptionPane.showMessageDialog(null, "input modified") ;  
    	            pst.close(); 
